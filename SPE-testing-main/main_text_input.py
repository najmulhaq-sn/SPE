...
count_exist = int(lines[2].split(":")[1].strip())
age_exist = int(lines[3].split(":")[1].strip())
lo_thresh = float(lines[4].split(":")[1].strip())
up_thresh = float(lines[5].split(":")[1].strip())
space_availability = lines[6].split(":")[1].strip()
spacing_parallel = float(lines[7].split(":")[1].strip())
spacing_along = float(lines[8].split(":")[1].strip())
species_type = lines[9].split(":")[1].strip()
region_type = lines[10].split(":")[1].strip()
annual_rainfall = float(lines[11].split(":")[1].strip())
DBH_cm = float(lines[12].split(":")[1].strip())
Height_cm = float(lines[13].split(":")[1].strip())
...
fig = green_cover_plot(ndvi,ndvi_d,forest_cover,count_exist,above_ground_biomass_kg)
fig2 = green_cover_plot_smooth(ndvi,ndvi_d,forest_cover,count_exist,above_ground_biomass_kg,kml_file_name_no_ext)
