...
config.sh_client_id = 'acec8bdf-2535-4f11-995e-b7dd50c919d6'
config.sh_client_secret = 'mDIOycyGMC}5ZZ7mJ3C:JKvkA[Aq((ODN,|C8hiz'
config.instance_id = "ee768e02-61bf-4a2e-9e1b-a09e54e75a1d"
config.save()
...
def senti_api (poly):
    ...
    img = list_of_requests[pos][0][:, :, [0, 1, 2,3,4]]
    print("Cloud Pixel: ",(np.count_nonzero((list_of_requests[pos][0][:, :, [4]]) == 1))*1e-4," km2")
